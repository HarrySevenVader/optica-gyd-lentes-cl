...
import './compra.css'
import { businessConfig } from '@/app/lib/siteConfig'
import osito from '@/app/images/osito.png'
          ...
          <div className="compra-card compra-card--online">
            <div className="compra-card-header">
              ...
              <div>
                ...
                <p className="compra-card-via">Canales digitales</p>
              </div>
            </div>
            ...
            <div className="compra-online-mascota">
              <Image
                src={osito}
                alt="Osito de Optica GYD"
                width={280}
                height={280}
                className="compra-online-mascota-img"
          ...
          <div className="compra-card compra-card--presencial">
            ...
            <div className="compra-presencial-info">
              ...
              <div className="compra-info-row">
                ...
                <span>{businessConfig.openingHours.weekdays} | {businessConfig.openingHours.saturday}</span>
              </div>
