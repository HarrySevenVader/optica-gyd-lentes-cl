...
export default function Resenas() {
  ...
  // Dividir reseñas en filas de 3
  const fila1 = resenas.slice(0, 3)
  const fila2 = resenas.slice(3, 6)
  ...
  return (
    ...
    >
      <div className="resenas-container">
        ...
        {/* Fila 1 - Primeras 3 reseñas */}
        <div className="resenas-grid">
          {fila1.map((resena, index) => (
            <div className="resenas-card" key={index}>
        ...
        {/* Fila 2 - Siguientes 3 reseñas */}
        <div className="resenas-grid">
          {fila2.map((resena, index) => (
            <div className="resenas-card" key={index + 3}>
              <div className="resenas-card-header">
                <div className="resenas-avatar">
                  {resena.foto ? (
                    <Image
